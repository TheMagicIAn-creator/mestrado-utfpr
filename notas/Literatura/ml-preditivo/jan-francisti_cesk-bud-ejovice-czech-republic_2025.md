---
titulo: Cesk Bud Ejovice Czech Republic
autor: Jan Francisti
ano: 2025
tema: ML Preditivo
...
- integration. This study presents a machine learning-driven framework for performance modeling, anomaly
- Forest Regressor achieved high fidelity in power prediction (R² = 0.995, MAE = 0.12 kW), while classification
- models categorized output levels with 100 % accuracy under static conditions. Anomaly detection using Z-score
